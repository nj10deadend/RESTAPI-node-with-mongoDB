...
function Signup () {
    ...
    // const userFormData = {name: name, email: email, password: password, admin: admin};
    const [userFormData, setUserFormData] = useState({name: name, email: email, password: password, admin: admin})
    ...
    return (
        <Box className="signup">
            <Typography variant="h3" component="h2" gutterBottom>Create a new Account</Typography>
